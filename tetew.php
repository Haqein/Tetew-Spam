...
#Dilarang copyright Tetew Crew - Information Internet 03 09 2018 19:00
...
if(is_numeric($argv[1])) {
	...
	while(1) {
		...
		echo "[]Tetew Crew Massage To[] # ".$G.$argv[1].$X."\n";	
...
echo "[]Tetew Crew Sending Massage To[] # ".$G.$argv[2].$X."\n";
